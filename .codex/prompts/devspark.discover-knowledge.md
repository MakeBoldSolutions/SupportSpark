...
1. `.documentation/{git-user}/commands/devspark.discover-knowledge.md` (personalized override)
2. `.documentation/commands/devspark.discover-knowledge.md` (team customization)
